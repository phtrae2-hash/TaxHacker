    ...
    <div className="w-full flex justify-between items-center">
      <div className="w-full flex flex-row gap-2 items-center justify-between">
        ...
        <FormInput
          ...
          value={fee.name}
          onChange={(e) => onChange(index, "name", e.target.value)}
          placeholder="Nome da taxa ou do desconto"
        />
        <FormInput
          type="number"
          step="0.01"
    ...
    <div className="relative w-full max-w-[794px] sm:w-[794px] min-h-[297mm] bg-white shadow-lg p-2 sm:p-8 mb-8">
      ...
      <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 justify-between items-start mb-8 relative">
        <div className="w-full flex flex-col space-y-2">
          ...
          />
          <FormInput
            placeholder="ID da fatura ou subtítulo"
      ...
      <div className="relative grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 mb-8">
        <div className="flex flex-col gap-1">
          ...
          <FormTextarea
            ...
            rows={4}
            placeholder="Nome da empresa, endereço, cidade, estado, CEP, país, CNPJ"
            required
          />
        </div>
        <div className="flex flex-col gap-1">
          ...
          <FormTextarea
            ...
            rows={4}
            placeholder="Nome do cliente, endereço, cidade, estado, CEP, país, CNPJ"
            required
          />
        </div>
      </div>
      ...
      <div className="mb-8">
        <FormTextarea
          ...
          rows={3}
          placeholder="Anotações ou condições adicionais"
        />
      </div>
      ...
      <div className="flex justify-end">
        <div className="w-full sm:w-72 space-y-2">
          ...
          <label className="flex items-center space-x-1">
            ...
            />
            <span className="text-gray-600 text-xs sm:text-sm">Os impostos estão incluídos no preço</span>
          </label>
      ...
      <div className="mt-8 pt-8 border-t">
        <textarea
          ...
          rows={3}
          placeholder="Dados bancários e de pagamento: número da conta, nome do banco, IBAN, SWIFT/BIC, seu e-mail (opcional)"
          required
        />
      </div>
    </div>
